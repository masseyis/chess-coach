...
export const ENGINE_DIFFICULTIES: EngineDifficulty[] = [
  ...
  },
  {
    ...
    engineDepth: 5,
    skillLevel: 3,
    imperfectionProfile: { quiet: 0.3, forcing: 0.12, random: 0.05, best: 0.53 },
  },
  {
    ...
    engineDepth: 5,
    skillLevel: 5,
    imperfectionProfile: { quiet: 0.22, forcing: 0.1, random: 0.04, best: 0.64 },
  },
  {
    ...
    engineDepth: 5,
    skillLevel: 6,
    imperfectionProfile: { quiet: 0.12, forcing: 0.08, random: 0.02, best: 0.78 },
  },
  {
    id: "depth-6",
